...
public class Graph {
	...
	Collection<restrictions> restriction;
	...
	public Graph(File nodes, File roads, File segments, File polygons,File restriction) {
		...
		this.restriction = Parser.parseRestriction(restriction, this);
	}
