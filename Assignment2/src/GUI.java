...
public abstract class GUI {
	 ...
	 */
	public enum Move {
		NORTH, SOUTH, EAST, WEST, ZOOM_IN, ZOOM_OUT,FIND_FASTEST,FIND_SHORTEST, ArticulationPoints,CAR, PEDESTRIAN,BICYLE,RESTRICTIONS
		};
	...
	private void initialise() {
		...
		load.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				...
				if (fileChooser.showOpenDialog(frame) == JFileChooser.APPROVE_OPTION) {
					...
					// method in your code.
					if (nodes == null || roads == null || segments == null || restriction == null) {
		...
		JButton pedestrians = new JButton("Pedestrians");
		pedestrians.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				Pathfinding.Vehicle = "pedestrians";
				onMove(Move.PEDESTRIAN);
				redraw();
			}
		});
		...
		bicycle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				Pathfinding.Vehicle = "bicycle";
				onMove(Move.BICYLE);
				redraw();
			}
		});
		
		JButton FindFastestRoad = new JButton("Find Fastest Road");
		FindFastestRoad.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				Pathfinding.condition = "FindFastest";
				onMove(Move.FIND_FASTEST);
				redraw();
			}
		});
		
		JButton FindShortestRoad = new JButton("Find Shortest Road");
		FindShortestRoad.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				Pathfinding.condition = "FindShortest";
				onMove(Move.FIND_SHORTEST);
				redraw();
			}
		});
		
		JButton ArticulationPoints = new JButton("Articulation Points");
		ArticulationPoints.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				onMove(Move.ArticulationPoints);
				redraw();
			}
		});
		...
		algorithm.setLayout(new GridLayout(2, 4));
		algorithm.add(ArticulationPoints);
		algorithm.add(FindShortestRoad);
		algorithm.add(FindFastestRoad);
		algorithm.add(restrictions);
		algorithm.add(car);
		algorithm.add(bicycle);
		algorithm.add(pedestrians);
