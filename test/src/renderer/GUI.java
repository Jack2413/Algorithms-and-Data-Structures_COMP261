...
public abstract class GUI {
	...
	public int[] getAmbientLight() {
	 ...
	 public int[] getDirectLight() {
	        return new int[] { DLred.getValue(), DLgreen.getValue(), DLblue.getValue() };
	    }
	...
	private final JSlider DLred = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);
    private final JSlider DLgreen = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);
    private final JSlider DLblue = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);
	...
	private void initialise() {
		...
		DLred.setBackground(new Color(230, 50, 50));
		DLgreen.setBackground(new Color(50, 230, 50));
		DLblue.setBackground(new Color(50, 50, 230));
		
		JPanel sliderparty2 = new JPanel();
		sliderparty2.setLayout(new BoxLayout(sliderparty2, BoxLayout.PAGE_AXIS));
		sliderparty2.setBorder(BorderFactory.createTitledBorder("DirectLight"));

		sliderparty2.add(DLred);
		sliderparty2.add(DLgreen);
		sliderparty2.add(DLblue);
        ...
        DLred.addChangeListener(Directlistener);
        DLgreen.addChangeListener(Directlistener);
        DLblue.addChangeListener(Directlistener);
        
		KeyboardFocusManager manager2 = KeyboardFocusManager.getCurrentKeyboardFocusManager();
		manager2.addKeyEventDispatcher(new KeyEventDispatcher() {
